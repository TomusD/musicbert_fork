...
# (Triantafulloy) Added this flag to control whether to use PeFTs or not
_USE_PEFTS = False
def set_use_pefts(use_pefts: bool):
    global _USE_PEFTS
    _USE_PEFTS = use_pefts
    if _USE_PEFTS:
        LOGGER.info("Using patched forward method for MultiheadAttention to support PeFTs.")
    else:
        LOGGER.info("Using original forward method for MultiheadAttention without PeFTs.")
